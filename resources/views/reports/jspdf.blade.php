            ...
            try {
                ...
                var createPDF = function(update_preview) {
                    ...
                    if (img_data) {
                        ...
                        pdf.addImage(img_data.src, img_data.type, img_sizes.centered_x, 10, img_sizes.w, img_sizes.h);

                        _y += (img_sizes.h + vspace + lineHeight);
