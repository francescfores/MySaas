    ...
    <table style="margin-left: auto; margin-right: auto" width="550">
        ...
        <tr valign="top">
            ...
            <td>
                ...
                <strong>To:  </strong> Francesc Forés
                <br>
                {{--<strong>Date:</strong> {{ $invoice->date()->toFormattedDateString() }}--}}
                <strong>Date:</strong> 4/4/2016
            </td>
        </tr>
        <tr valign="top">
            ...
            <td>
                ...
                <p>
                    ...
                    <strong>Product:</strong> Producte 1<br>
                    {{--<strong>Invoice Number:</strong> {{ $id or $invoice->id }}<br>--}}
                    <strong>Invoice Number:</strong> id 32<br>
                ...
                <table width="100%" class="table" border="0">
                    ...
                    {{--@foreach ($invoice->invoiceItems() as $item)--}}
                        ...
                        {{--@endforeach--}}
                    <tr>
                        <td colspan="2">description item</td>
                        <td>total</td>
                    </tr>
                        ...
                        {{--@foreach ($invoice->subscriptions() as $subscription)--}}
                            ...
                            {{--@endforeach--}}
                    <tr>
                        <td>Subscription Subscriptions</td>
                        <td>Star date</td>
                        <td>total</td>
                    </tr>
